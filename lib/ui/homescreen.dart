  ...
  Widget build(BuildContext context) {
    Widget Drawers() {
      return CollapsibleSidebar(
        ...
        title: 'SheHeroes',
        avatarImg: AssetImage('assets/SheHeroes.png'),
        ...
        backgroundColor: HexColor('#F7BB97'),
        selectedIconBox: Colors.white38,
        selectedIconColor: HexColor('#ea6a88'),
        selectedTextColor: HexColor('#ea6a88'),
                      ...
                      children: [
                        Dialog(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                  width: 20.0, color: Colors.orange[800]),
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 80,
        backgroundColor: HexColor('#FBBFB3'),
        elevation: 0,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: CircleList(
                                ...
                                outerCircleColor: HexColor('#FBBFB6'),
                                origin: Offset(0, 0),
      ...
      bottomNavigationBar: FancyBottomNavigation(
        ...
        inactiveIconColor: HexColor('#ffffff'),
        barBackgroundColor: HexColor('#F7BB97'),
